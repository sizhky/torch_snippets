...
# %% auto 0
__all__ = ['is_in_notebook', 'save_notebook', 'backup_this_notebook', 'backup_all_notebooks', 'backup_folders_of_nbs',
           'display_dfs_side_by_side', 'show_big_dataframe', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'store_scrap',
