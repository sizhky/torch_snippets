...
# %% auto 0
__all__ = ['console', 'logger', 'Excep', 'frames', 'get_console', 'reset_logger', 'reset_logger_width', 'Trace', 'Debug', 'Info',
           'Warn', 'Error', 'get_logger_level', 'logger_mode', 'in_logger_mode', 'warn_mode', 'info_mode', 'debug_mode',
           'trace_mode', 'excep_mode', 'in_warn_mode', 'in_info_mode', 'in_debug_mode', 'in_trace_mode',
           'in_excep_mode', 'notify_waiting']
